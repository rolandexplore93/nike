      ...
      >
        <div className="relative flex flex-col justify-center items-start w-full xl:w-2/5 max-xl:padding-x pt-28">
          ...
          <h1 className='mt-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[82] font-bold'>
            <span className='xl:bg-white xl:whitespace-nowrap z-10 pr-10'>The New Arrival</span> <br />
          ...
          <div className='flex justify-start items-start flex-wrap w-full mt-20 gap-16'>
            {statistics.map((stat) => (
              <div key={stat.label}>
                <p className='text-4xl font-palanquin text-slate-gray'>{stat.value}</p>
        ...
        max-xl:py-40 bg-primary bg-hero bg-cover bg-center'>
          <img src={bigShoe1} alt="bigshoe1" width={610} height={500} className='object-contain relative z-10' />
